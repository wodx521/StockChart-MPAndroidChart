...
public class CandleCombinedChart extends CombinedChart {
    ...
    public StockKLineDataManage kLineData;
    ...
    public void setMarker(LeftMarkerView markerLeft, KRightMarkerView markerRight, StockKLineDataManage kLineData) {
    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            if (pos[0] >= CommonUtil.getWindowWidth(getContext()) / 2) {
                float yValForXIndex1 = (float) kLineData.getKLineDatas().get((int) mIndicesToHighlight[i].getX()).close;
                ...
                float yValForXIndex2 = (float) kLineData.getKLineDatas().get((int) mIndicesToHighlight[i].getX()).close;
