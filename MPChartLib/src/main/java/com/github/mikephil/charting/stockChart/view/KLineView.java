...
public class KLineView extends BaseView {
     ...
     * 设置K线数据
     */
    public void setDataToChart(StockKLineDataManage data) {
        kLineData = data;
...
//        }
    ...
    public void setMarkerView(StockKLineDataManage kLineData) {
    ...
    public void setBottomMarkerView(StockKLineDataManage kLineData) {
