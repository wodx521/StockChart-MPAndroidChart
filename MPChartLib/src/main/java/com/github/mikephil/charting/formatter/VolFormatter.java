...
public class VolFormatter implements IAxisValueFormatter {
    ...
    public String getFormattedValue(float value, AxisBase axis) {
        ...
        if (value == 0) {
            ...
            if (e2 >= 8) {
                u = context.getResources().getString(R.string.billions_shou);
            } else if (e2 >= 4) {
                u = context.getResources().getString(R.string.millions_shou);
            } else {
                u = context.getResources().getString(R.string.shou);
            }
            return u;
        }
